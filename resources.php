      ...
      <div class="md:mx-8">
        ...
        <div class="md:flex justify-items-stretch gap-12">
          ...
          <div class="b3-shadow w-full md:w-1/2 px-12 pt-8 pb-12">
            <h5 class="text-primary text-center">Check Stock</h5>
            <form action="" method="" enctype="multipart/form-data">
              <input type="text" placeholder="User Name" name="" required>
              <input type="password" placeholder="Password" name="" required>
              <div class="flex mt-4">
      ...
      <div class="md:mx-8">
        <div class="md:flex justify-items-stretch gap-12">
          <div class="b3-shadow w-full md:w-1/2 px-12 pt-8 pb-12">
            ...
            <form action="" method="" enctype="multipart/form-data" class="mb-8">
              <input type="text" placeholder="User Name" name="" required>
              <input type="password" placeholder="Password" name="" required>
              <div class="flex mt-4">
                <div class="w-1/2">
            ...
            <ul class="inline-list text-center line-seperator pad-more no-leading">
              <li>
                <a href="#">Francais</a>
              </li>
              <li>
          ...
          <div class="w-full md:w-1/2 flex">
            <div class="flex justify-center w-full items-center">
              <p class="text-center py-12">
                For login asstistance, please <br />contact the marketing <br />department at <a href="tel:+18172583000" class="font-bold">817-258-3000</a>.
              </p>
            </div>
          </div>
        </div>
